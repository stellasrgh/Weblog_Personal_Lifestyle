				...
				<div class="col-lg-8 left-blog-info-w3layouts-agileits text-left">
					<div class="row mb-4">
						<div class="col-md-6 card">
							<a href="single.html">
								<img src="images/Thai2.jpg" class="card-img-top img-fluid" alt="">
							</a>
							<div class="card-body">
								...
								<h5 class="card-title ">
									<a href="single.html">Hatyai, Thailand</a>
								</h5>
						...
						<div class="col-md-6 card">
							...
							<div class="card-body">
								...
								<h5 class="card-title ">
									<a href="single.html">Pulau Pinang, Malaysia</a>
								</h5>
								<p class="card-text mb-3">Lorem ipsum dolor sit amet consectetur adipisicing elit sedc dnmo eiusmod tempor incididunt.. </p>
								<a href="single.html" class="btn btn-primary read-m">Read More</a>
							</div>
						...
						<div class="col-md-6 card my-4">
							...
							<div class="card-body">
								...
								<h5 class="card-title ">
									<a href="single.html">Kuala Lumpur, Malaysia</a>
								</h5>
								<p class="card-text mb-3">Lorem ipsum dolor sit amet consectetur adipisicing elit sedc dnmo eiusmod tempor incididunt.. </p>
								<a href="single.html" class="btn btn-primary read-m">Read More</a>
							</div>
						...
						<div class="col-md-6 card my-4">
							<a href="single.html">
								<img src="images/pramb1.jpg" class="card-img-top img-fluid" alt="">
							</a>
							<div class="card-body">
								<ul class="blog-icons my-4">
									<li>
								...
								<h5 class="card-title ">
									<a href="single.html">Yogyakarta, Indonesia</a>
								</h5>
								<p class="card-text mb-3">Lorem ipsum dolor sit amet consectetur adipisicing elit sedc dnmo eiusmod tempor incididunt.. </p>
								<a href="single.html" class="btn btn-primary read-m">Read More</a>
							</div>
