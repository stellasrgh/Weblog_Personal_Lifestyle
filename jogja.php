				...
				<div class="left-blog-info-w3layouts-agileits text-left">
					<div class="row">
						<div class="col-lg-4 card">
							<a href="single.html">
								<img src="images/wedi1.jpeg" class="card-img-top img-fluid" alt="">
							</a>
							<div class="card-body">
						...
						<div class="col-lg-4 card">
							<a href="single.html">
								<img src="images/mesra1.jpeg" class="card-img-top img-fluid" alt="">
							</a>
							<div class="card-body">
								<ul class="blog-icons my-4">
									<li>
								...
								<h5 class="card-title ">
									<a href="single.html"> Pantai Mesra </a>
								</h5>
