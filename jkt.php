...
<?php include "header.php"?>
	...
	<ol class="breadcrumb">
		...
		<li class="breadcrumb-item active">Yogyakarta</li>
	</ol>
	<!--//banner-->
	...
	<section class="main-content-w3layouts-agileits">
		<div class="container">
			<h3 class="tittle">D. I. Yogyakarta</h3>
			<div class="inner-sec">
				<!--left-->
				<div class="left-blog-info-w3layouts-agileits text-left">
					<div class="row">
						<div class="col-lg-4 card">
							<a href="single.html">
								<img src="images/Wediombo.jpeg" class="card-img-top img-fluid" alt="">
							</a>
							<div class="card-body">
								<ul class="blog-icons my-4">
									<li>
										<a href="#">
											<i class="far fa-calendar-alt"></i> Nov 24 .2023</a>
									</li>
									<li class="mx-2">
										<a href="#">
								...
								<h5 class="card-title">
									<a href="single.html"> Pantai Wediombo </a>
								</h5>
						...
						<div class="col-lg-4 card">
							<a href="single.html">
								<img src="images/Baronsampan.jpg" class="card-img-top img-fluid" alt="">
							</a>
							<div class="card-body">
								<ul class="blog-icons my-4">
									<li>
								...
								<h5 class="card-title ">
									<a href="single.html"> Pantai Baron </a>
								</h5>
						...
						<div class="col-lg-4 card">
							<a href="single.html">
								<img src="images/Wulenpari.jpeg" class="card-img-top img-fluid" alt="">
							</a>
							<div class="card-body">
								<ul class="blog-icons my-4">
									<li>
								...
								<h5 class="card-title ">
									<a href="single.html"> Wulenpari, Jelok, Beji </a>
								</h5>
