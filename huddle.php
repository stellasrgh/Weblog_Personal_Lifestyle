...
<body>
	...
	<ol class="breadcrumb">
		...
		<li class="breadcrumb-item active"> Huddle - Engagement</li>
	</ol>
			...
			<div class="row">
				...
				<div class="col-lg-8 left-blog-info-w3layouts-agileits text-left">
					<!-- <div class="blog-grid-top">
						<div class="b-grid-top">
							...
							<div class="blog-info-middle">
								<ul>
									<li>
										<a href="#">
											<i class="far fa-calendar-alt"></i> OCT 26,2023</a>
									</li>
									<li class="mx-2">
										<a href="#">
									...
									<li>
										<a href="form_comment_huddle.php">
						...
						<h3>
							<a href="huddle.php">Amet consectetur adipisicing </a>
						</h3>
						<p>Last huddle, last team engagement, a farewell for me.</p>
