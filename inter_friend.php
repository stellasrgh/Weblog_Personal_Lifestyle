...
<?php include "header.php"?>
	...
	<ol class="breadcrumb">
		...
		<li class="breadcrumb-item active">International Friend trips</li>
	</ol>
	<!--//banner-->
				...
				<div class="left-blog-info-w3layouts-agileits text-left">
					<div class="row">
						<div class="col-lg-4 card">
							<a href="single.html">
								<img src="images/L1.jpg" class="card-img-top img-fluid" alt="">
							</a>
							<div class="card-body">
								<ul class="blog-icons my-4">
									<li>
										<a href="#">
											<i class="far fa-calendar-alt"></i> Jan 13 .2023</a>
									</li>
									<li class="mx-2">
										<a href="#">
								...
								<h5 class="card-title">
									<a href="single.html">London, England; United Kingdom</a>
								</h5>
								<p class="card-text mb-3"> WINTER; The people who are not your vibrational match, will be removed from your life by the universe, no matter how hard you try to keep them. </p>
								<a href="single.html" class="btn btn-primary read-m">Read More</a>
							</div>
						</div>
						<div class="col-lg-4 card">
							<a href="single.html">
								<img src="images/L2.jpg" class="card-img-top img-fluid" alt="">
							</a>
							<div class="card-body">
								<ul class="blog-icons my-4">
									<li>
										<a href="#">
											<i class="far fa-calendar-alt"></i> Jun 12 .2023</a>
									</li>
									<li class="mx-2">
										<a href="#">
											<i class="far fa-comment"></i> 21</a>
								...
								<p class="card-text mb-3"> SUMMER; The universe gives you what you are, not what you want.</p>
								<a href="single.html" class="btn btn-primary read-m">Read More</a>
							</div>
						</div>
						<div class="col-lg-4 card">
							<a href="single.html">
								<img src="images/Edinburgh.jpg" class="card-img-top img-fluid" alt="">
							</a>
							<div class="card-body">
								<ul class="blog-icons my-4">
									<li>
								...
								<h5 class="card-title ">
									<a href="single.html">Edinburgh, Scotland; United Kingdom</a>
								</h5>
						...
						<div class="col-lg-4 card my-lg-4 my-md-1 my-0">
							<a href="single.html">
								<img src="images/Highland2.jpg" class="card-img-top img-fluid" alt="">
							</a>
							<div class="card-body">
								<ul class="blog-icons my-4">
									<li>
										<a href="#">
											<i class="far fa-calendar-alt"></i> Jun 16 .2023</a>
									</li>
									<li class="mx-2">
										<a href="#">
											<i class="far fa-comment"></i> 21</a>
								...
								<h5 class="card-title">
									<a href="single.html">Highlands, Scotland; United Kingdom</a>
								</h5>
								<p class="card-text mb-3">Lorem ipsum dolor sit amet consectetur adipisicing elit sedc dnmo eiusmod tempor incididunt.. </p>
								<a href="single.html" class="btn btn-primary read-m">Read More</a>
							</div>
